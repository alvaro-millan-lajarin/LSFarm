...
void motorInitialize() {
    ...
    static unsigned char field[15];
    static unsigned char fi = 0;
    ...
    switch(estat) {
        ...
        case 5:
            unsigned int scaled = (unsigned int)result * (unsigned int)601;

            if (field_num == 1) {
                DO_SetCowTime(scaled);
            }
            else if (field_num == 2) {
                DO_SetPigTime(scaled);
            }
            else if (field_num == 3) {
                DO_SetHorseTime(scaled);

            }
            else if (field_num == 4) {
                DO_SetHenTime(scaled);
                estat = 6;
                return;
            }
            field_num++;

...
void motorButton(){
    ...
    switch (estat){
        ...
        break;
        case 1:
            if (TI_GetTics(12) >= 77 && PORTBbits.RB0 == 0) {
                estat = 2;

            } else if (TI_GetTics(12) >= 77 && PORTBbits.RB0 != 0) {

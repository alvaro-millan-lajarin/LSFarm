...
static unsigned char productos[4] = {0};
static unsigned char rebelion = 0;
static unsigned char consumePending = 0;
static unsigned char consumeTipo = 0;

static unsigned char nuevoProducto = 0;
static unsigned char tipusUltimoProducto = 0;
static unsigned char numUltimoProducto = 0;


void resetNuevoProducto(void) { nuevoProducto = 0; }
unsigned char hayNuevoProducto(void) { return nuevoProducto; }
unsigned char getTipusUltimoProducto(void) { return tipusUltimoProducto; }
unsigned char getNumUltimoProducto(void) { return numUltimoProducto; }
...
void motorProducts() {
    ...
    static unsigned char tipusActual = 0;
        ...
        case 1:
            if (i < getNumTotalAnimals()) {
                ...
                if (a.tipus == tipusActual) {
                    ...
                    unsigned char awake = !EEPROM_GetEstat(a,DT_GetHora(), DT_GetMin(), DT_GetSeg());

                    if (awake && !rebelion) {
                        productos[tipusActual]++;
                        tipusUltimoProducto = tipusActual;
                        numUltimoProducto = productos[tipusActual];
                        nuevoProducto = 1;
